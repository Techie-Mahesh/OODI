...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "hero.subtitle": "The smartest way to prepare for Class 10 (SSLC). Personalized daily tasks, adaptive quizzes, and real-time progress tracking.",
    ...
    "feature.tasks.desc": "Bite-sized tasks every day based on your syllabus and weak areas.",
    "feature.goals": "Goal-Based Learning",
    "feature.goals.desc": "Target 'Pass', 'First Class', or 'Distinction'. We customize the path.",
    "feature.bilingual": "Kannada & English",
    "feature.bilingual.desc": "Switch languages instantly to understand complex concepts better.",
    "auth.welcome": "Welcome to OODI",
    "auth.subtitle": "Enter your credentials to access your personalized learning path.",
    "auth.login": "Login",
    "auth.signup": "Sign Up",
    "auth.email": "Email",
  ...
  kn: {
    ...
    "hero.title": "ನಿಮ್ಮ ಪಠ್ಯಕ್ರಮವನ್ನು ಕರಗತ ಮಾಡಿಕೊಳ್ಳಿ. ನಿಮ್ಮ ಗುರಿಗಳನ್ನು ಸಾಧಿಸಿ.",
    "hero.subtitle": "10ನೇ ತರಗತಿ (SSLC) ಗೆ ತಯಾರಿ ನಡೆಸಲು ಅತ್ಯುತ್ತಮ ಮಾರ್ಗ. ವೈಯಕ್ತೀಕರಿಸಿದ ದೈನಂದಿನ ಕಾರ್ಯಗಳು ಮತ್ತು ಪ್ರಗತಿ ಪರಿಶೀಲನೆ.",
    ...
    "feature.tasks.desc": "ನಿಮ್ಮ ಪಠ್ಯಕ್ರಮ ಮತ್ತು ದುರ್ಬಲ ವಿಷಯಗಳ ಆಧಾರದ ಮೇಲೆ ಪ್ರತಿದಿನದ ಚಿಕ್ಕ ಕಾರ್ಯಗಳು.",
    "feature.goals": "ಗುರಿ ಆಧಾರಿತ ಕಲಿಕೆ",
    "feature.goals.desc": "'ಪಾಸ್', 'ಫರ್ಸ್ಟ್ ಕ್ಲಾಸ್' ಅಥವಾ 'ಡಿಸ್ಟಿಂಕ್ಷನ್' ಗುರಿಯನ್ನು ಆರಿಸಿ. ನಾವು ಅದಕ್ಕೆ ತಕ್ಕಂತೆ ಕಲಿಸುತ್ತೇವೆ.",
    "feature.bilingual": "ಕನ್ನಡ ಮತ್ತು ಇಂಗ್ಲಿಷ್",
    "feature.bilingual.desc": "ಕ್ಲಿಷ್ಟಕರವಾದ ವಿಷಯಗಳನ್ನು ಅರ್ಥಮಾಡಿಕೊಳ್ಳಲು ಭಾಷೆಯನ್ನು ಬದಲಾಯಿಸಿ ಕಲಿಯಿರಿ.",
    ...
    "dash.track": "ನಿಮ್ಮ 'ಡಿಸ್ಟಿಂಕ್ಷನ್' ಗುರಿಯತ್ತ ನೀವು ಸರಿಯಾದ ಹಾದಿಯಲ್ಲಿದ್ದೀರಿ. ಹೀಗೆ ಮುಂದುವರಿಸಿ!",
